...
public class Producto {
	 ...
	 * @param p_procPtoRepo porcentaje de punto de reposicion¿ (nose que es esto)
	 * @param p_existMinima Minimo de cantidad de producto
	...
	public void mostrarLinea() {
		// nueva forma de mostrar las cosas
